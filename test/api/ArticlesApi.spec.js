...
(function(root, factory) {
  ...
  describe('ArticlesApi', function() {
    ...
    describe('articleUuidStubGet', function() {
      it('should call articleUuidStubGet successfully', function(done) {
        //uncomment below and update the code to test articleUuidStubGet
        //instance.articleUuidStubGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
