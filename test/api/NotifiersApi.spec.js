...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Lettera.NotifiersApi();
  });
  ...
  describe('NotifiersApi', function() {
    describe('notifyPost', function() {
      it('should call notifyPost successfully', function(done) {
        //uncomment below and update the code to test notifyPost
        //instance.notifyPost(function(error) {
