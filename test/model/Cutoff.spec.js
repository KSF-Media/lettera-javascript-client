...
(function(root, factory) {
  ...
  describe('Cutoff', function() {
    it('should create an instance of Cutoff', function() {
      // uncomment below and update the code to test Cutoff
      //var instance = new Lettera.Cutoff();
      //expect(instance).to.be.a(Lettera.Cutoff);
    });
